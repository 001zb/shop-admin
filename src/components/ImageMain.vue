<template>
    <el-main class="image-main" v-loading="loading">
        <div class="top p-3">
            <el-row :gutter="10">
                <el-col :span="6" v-for="(item, index) in list" :key="index" :offset="0">
                    <el-card shadow="hover" class="relative cursor-pointer mb-3" :body-style="{ 'padding': 0 }" :class="{'border-blue-500':item.checked}">
                        <!-- :lazy="true" -->
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            <el-popconfirm width="220" title="是否要删除该图片？" confirm-button-text="确认" cancel-button-text="取消"
                                @confirm="handleDelete(item.id)" :icon="InfoFilled" icon-color="#626AEF" >
                                <template #reference>
