    ...
    <el-card shadow="always" class="border-0">
        ...
        <el-table :data="tableData" style="width: 100%" v-loading="loading">
            ...
            <el-table-column label="状态" width="120px" align="center">
                <template #default="{row}">
                    <el-switch :modelValue="row.status" :active-value="1" :inactive-value="0" @change="hanleStatusChange($event,row)" :loading="row.statusLoading" :disabled="row.super == '1'">
                    </el-switch>
            ...
            <el-table-column label="操作" width="180px" align="center">
                <template #default="scope">
                    <small v-if="scope.row.super == 1" class="text-sm text-gray-300">暂无操作</small>
                    <div v-else>
                        <el-button type="primary" size="small" text @click="handleEdit(scope.row)">修改</el-button>
                        <el-popconfirm width="220" confirm-button-text="确认" cancel-button-text="取消"
                        @confirm="handleDelete(scope.row.id)" :icon="InfoFilled" icon-color="#626AEF" title="是否要删除该管理员">
                            <template #reference>
