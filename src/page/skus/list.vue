<template>
    <el-card shadow="always" class="border-0">
        ...
        <el-table ref="multipleTableRef" @selection-change="handleSelectionChange " :data="tableData" style="width: 100%" v-loading="loading">
            ...
            <el-table-column label="操作" width="250px" align="center">
                <template #default="scope">
                    ...
                    <el-popconfirm width="220" confirm-button-text="确认" cancel-button-text="取消"
                        @confirm="handleDelete(scope.row.id)" :icon="InfoFilled" icon-color="#626AEF" title="是否要删除该规格">
                        <template #reference>
