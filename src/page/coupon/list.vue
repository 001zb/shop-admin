<template>
    <el-card shadow="always" class="border-0">
        ...
        <el-table :data="tableData" style="width: 100%" v-loading="loading">
            ...
            <el-table-column prop="statusText" label="状态" width="380" />
            ...
            <el-table-column label="操作" width="180px" align="center">
                <template #default="scope">
                    ...
                    <el-popconfirm v-if="scope.row.statusText != '领取中'" width="220" confirm-button-text="确认" cancel-button-text="取消"
                        @confirm="handleDelete(scope.row.id)" :icon="InfoFilled" title="是否要删除该优惠券">
                        <template #reference>
                            <el-button type="primary" size="small" text >删除</el-button>
                        </template>
                    </el-popconfirm>
                    <el-popconfirm v-if="scope.row.statusText == '领取中'" width="220" confirm-button-text="失效" cancel-button-text="取消"
                        @confirm="handleStatusChange(0,scope.row)" :icon="InfoFilled" title="是否要让该优惠券失效">
                        <template #reference>
